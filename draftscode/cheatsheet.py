...
# map() — это встроенная функция Python, принимающая в
# качестве аргумента функцию и последовательность.
# Она работает так, что применяет переданную функцию к
# каждому элементу.
#
# Предположим, есть список целых чисел, которые нужно
# возвести в квадрат с помощью map.
